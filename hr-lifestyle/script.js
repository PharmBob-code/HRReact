...
//   const leftContainers = document.querySelectorAll(".left"); // Replace with your left container class
//   const rightContainers = document.querySelectorAll(".right"); // Replace with your right container class
...
// ... existing code for the "why-us" container ...
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  console.log(leftContainers); // Should log the NodeList
  console.log(rightContainers); // Should log the NodeList
});
