        ...
        <div className="services" id="services">
          ...
          <section className="hrtalent-mgt lh" id="talent-mgt">
            ...
            <div className="hrbody">
              <div className="left">
                <p>
                  We provide talent management solutions that nurture and
                  develop your employees. From performance management to
                  leadership development, our services are aimed at maximizing
                  your workforce's potential and aligning it with your business
                  goals.
                </p>
                <ul>
                  <li className="hrsubtitle">How We Achieve This:</li>
            ...
            <div className="hrbody">
              ...
              <div className="right">
                <p>
                  ...
                  technical skills, soft skills, or leadership training, we
                  create development plans that are aligned with your
                ...
                <ul>
                  ...
                  <ul>
                    ...
                    <li>
                      Deliver interactive and practical training sessions.
                    </li>
                    <li>
              ...
              <div className="left">
                ...
                <ul>
                  ...
                  <ul>
                    ...
                    <li>
                      Develop customized HR strategies that support your
                      business objectives.
                    </li>
                    <li>
                      Ensure compliance with labor laws and industry
                      regulations.
                    </li>
                    <li>
            ...
            <div className="hrbody">
              ...
              <div className="right">
                <p>
                  ...
                  HR Business Partner services are designed to strategically
                  align your HR functions with your overall business goals. As
                  your HR Business Partner, we work closely with your leadership
                  team to deliver tailored solutions that foster a productive
                  and engaged workforce. Partner with us to transform your HR
                  operations into a strategic asset that propels your business
                  forward.
                </p>
                <ul>
                  <li className="hrsubtitle">How We Achieve This:</li>
